...
export const NAVIGATION_CATEGORY_TREE_HZ_PATH = 'CategoryTreeHz';
...
export const NAVIGATION_OFFER_NAVIGATOR = 'OfferScreen';
export const NAVIGATION_SEARCHBAR_NAVIGATOR = 'SearchBarHome';
//export const NAVIGATION_HOME_SCROLL_CATEGORY_NAVIGATOR = 'HomeScrollCategory';
